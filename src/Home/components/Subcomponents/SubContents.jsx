...
import ModalperfilLeave from "./func/ModalperfilLeave";
import ModalShare from "../func/ModalShare";
import Like from "./func/Like";
import SavePublication from "./func/SavePublication";
...
const SubContents = (props) => {
        ...
        const modalperfilLeave = () => {
            ModalperfilLeave(props.Number)
        };
        ...
        const InSave = () => {
            SavePublication(props.SaveId);
        };

        return(
        <div className={`CC__div1 ${props.className}`} >
            <div className={`CC__div1_header ${props.ClassModalP}`} >
                <div className="CC__div1_header_dv1" onMouseLeave={modalperfilLeave} onMouseEnter={modalperfil}>
            ...
            <div className="CC__div1_publicacion">
                ...
                <div className="SavePublicacion" id={props.SaveId}>
                    <span>Your item has been saved.</span>
                    <a href="">View your save post</a>
                </div>
            </div>
            <div className="CC__div1_Opinion">
                <div className="Div1">
                    <i className={`bx bx-heart`} id={`${props.Like}`} onClick={InLike} ></i>
                    ...
                    <svg onClick={ModalShare}  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send" viewBox="0 0 16 16"><path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/></svg>
                </div>
                <div onClick={InSave} className="Div2">
                    <i className='bx bx-bookmark' id={`${props.SaveId}_${props.UserName}`}></i>
                </div>
